...
if ($stmt->rowCount() > 0) {
    ...
    <link rel="icon" type="image/x-icon" href="../assets/img/avatars/Cash OUT Co .png">
        <div class="bs-toast toast toast-placement-ex m-2 fade bg-warning top-50 start-50 translate-middle show" role="alert" aria-live="assertive" aria-atomic="true" data-delay="2000">
                ...
                <div class="toast-body">Account not found! <br> Make sure your details are correct</div>
        </div>
        ';
    }
}else {
    ...
    <link rel="icon" type="image/x-icon" href="../assets/img/avatars/Cash OUT Co .png">
        <div class="bs-toast toast toast-placement-ex m-2 fade bg-danger top-50 start-50 translate-middle show" role="alert" aria-live="assertive" aria-atomic="true" data-delay="2000">
                ...
                <div class="toast-body">Type some Details<br> You havent typed anything into the input boxes</div>
        </div>
        ';
}
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to CashOut! 👋</h4>
              <p class="mb-4">Please sign-in to your account to Either advertise or Earn</p>
              ...
              <form id="formAuthentication" class="mb-3" action="index.php" method="POST">
                ...
                <div class="mb-3">
                  <input id="showToastPlacement" class="btn btn-primary d-block btn-user w-100" type="submit" name="submit" value="Log In"/>
                </div>
              </form>

              <p class="text-center">
                <span>New on our platform?</span>
                <a href="registerEdit.php">
