            ...
            <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                    <div class="avatar flex-shrink-0">
                         <i class="homeIcon bx bx-color bx-tada bx-rotate-180"></i>
                    </div>
                </div>
                <span class="fw-semibold d-block mb-1">Spin $ Win</span>
                <h3 class="card-title text-nowrap mb-1">Ksh <br>';
                echo "$balanceFromSpins";
                echo'</h3>

                <small class="text-success fw-semibold"><i class="bx bxs-lock-alt"></i>Constant</small>
        ...
        <div class="col-lg-6 col-md-12 col-6 mb-4">
            <div class="card">
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                            <i class="homeIcon bx-tada bx bx-link"></i>
                        </div>
                    </div>
                    <span>Referrals</span>
                    <h3 class="card-title text-nowrap mb-1">Ksh <br>';
...
<div class="row">
    ...
    $stmt = $conn->prepare("SELECT * FROM transactions WHERE email=:email ORDER BY date DESC LIMIT 5");
    $stmt->bindParam(':email', $email);
    $stmt->execute();
