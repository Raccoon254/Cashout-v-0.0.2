...
echo '</h3>
            ...
            <div class="col-xl-8 mb-4 mt-4 d-flex ">
              <div class="d-flex h-px-50 w-100">
                ...
                <input class="form-control" type="text" id="referral-link" value="cashout.co.ke/html/registerEdit.php?x=';
echo "$referral_code";
echo '" readonly="">
              </div>
...
foreach ($referred_users as $user) {
  ...
  echo '<li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="" data-bs-original-title="';
  echo "" . $user['name'] . "";
  echo '">';
  ...
  echo '</td>
                            <td>';
  echo "<p class='mt-2 text-primary'>" . $user['type'] . "<p>";
  echo '</td>
                            <td class="d-flex">';
  echo "<p class='mt-2 text-danger'>+&nbsp</p><p class='mt-2 text-success'>" . $user['action'] . "<p>";
  echo '</td>
                            ';
  echo "
                          </tr>";
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://steve1is2the3best4designer.on.drv.tw/stevosoro.com" target="_blank" class="footer-link fw-bolder">raccoon254</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
